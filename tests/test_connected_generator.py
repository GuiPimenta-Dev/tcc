...
class TestConnectedGenerator:
    def test_motor_settings(self):
        expected_result = {
            'coords': {'Vt': (32.26, 0.0), 'Ia': (6.45, -4.838709677419354), 'Ea': (45.0, 15.64516129032258),
                       'RaIa': (0.65, -0.48387096774193544), 'jXsIa': (12.1, 16.129032258064516)},
            'labels': {'Vt': '480 ∠ 0°', 'Ia': '120 ∠ -36.87°', 'Ea': '708.91 ∠ 19.17°', 'RaIa': '12.0 ∠ -36.87°',
                       'jXsIa': '300.0 ∠ 53.13°'}, 'sliders': {'load': {'min': 0, 'max': 180.0, 'value': 85.42},
