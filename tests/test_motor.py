...
class TestMotor:
    ...
    def test_update_load(self):
        expected_result = {
            "coords": {
                "Vt": (39.86, 0.0),
                "Ia": (7.64, 2.0562465461406885),
                "Ea": (45.0, -19.102204633672304),
                "RaIa": (0.0, 0.0),
                "jXsIa": (-5.14, 19.102204633672304),
            },
            "labels": {
                "Vt": "208 ∠ 0°",
                "Ia": "41.29 ∠ 15.06°",
    ...
    def test_update_ea(self):
        expected_result = {
            "coords": {
                "Vt": (42.39, 0.0),
                "Ia": (4.47, 1.0435282029757045),
                "Ea": (45.0, -11.179203502581522),
                "RaIa": (0.0, 0.0),
                "jXsIa": (-2.61, 11.179203502581522),
            },
            "labels": {
                "Vt": "208 ∠ 0°",
                "Ia": "22.53 ∠ 13.13°",
