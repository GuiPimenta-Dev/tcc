...
generator_parser.add_argument('Ea', required=False, type=float, location='json', default=277)
...
generator_parser.add_argument('isolated', required=False, type=bool, location='json', default=True)
